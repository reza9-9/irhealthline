...
class MedicalContentBot:
    ...
    def translate_content(self, text):
        ...
        translations = {
            ...
            "Latest research on type 2 diabetes medications": "آخرین تحقیقات در مورد داروهای دیابت نوع ۲",
            "New immunotherapy approaches for lung cancer": "روش‌های جدید ایمنی‌درمانی برای سرطان ریه"
        }
